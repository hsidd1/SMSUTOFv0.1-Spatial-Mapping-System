...
#define PSYSDIV 0
// bus frequency is 20MHz/(PSYSDIV+1) = 20MHz/(0+1) = 20 MHz, 
// Standard frequency is with PSYDIV as 3 and MINT as 96 in PLL.c: // bus frequency is 480MHz/(PSYSDIV+1) = 480MHz/(3+1) = 120 MHz
