// PLL.c
// Runs on TM4C1294 
// Copyright information located at the bottom of the file
...
// default bus frequency is 480MHz/(PSYSDIV+1) = 480MHz/(3+1) = 120 MHz -- changed in this program for 20MHz
// IMPORTANT: See Step 6) of PLL_Init().  If you change something, change 480 MHz (in this case, change 20 MHz).
...
void PLL_Init(void){ uint32_t timeout;
  ...
  // Modified the following parameters for a 20MHz bus frequency:
...
// modified based on following copyright notice: 
